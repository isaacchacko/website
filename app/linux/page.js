    ...
    <>
      ...
      <div>
        ...
        <div className={styles.line}>
          ...
          <p>
            <a href='https://github.com/ranger/ranger'>ranger</a> is
          ...
          <p>
            <a href='https://github.com/dylanaraps/neofetch'>neofetch</a> is the bread and butter of virtually all unix users, no matter what distribution.
          ...
          <p>
            <a href='https://github.com/dpayne/cli-visualizer'>cli-visualizer</a> is
            a TUI visualizer majorly written in C++. It has a couple of modes (and also can simulate 
            the <a href='https://en.wikipedia.org/wiki/Lorenz_system'>Lorenz attractor</a>, go figure),
          ...
          <p>
            <a href='http://www.lazyvim.org/'>lazyvim</a> is
          ...
          <p>
            <a href='https://github.com/tobi-wan-kenobi/bumblebee-status'>bumblebee-status</a> is
            ...
            the <a href='https://bumblebee-status.readthedocs.io/en/latest/'>documentation</a> online
          ...
          <p>
            <a href='https://www.wallhaven.cc'>wallhaven</a> is
          ...
          <h2 id='pywal'>pyal</h2>
          <p>
            <a href='https://github.com/dylanaraps/pywal'>pywal</a> is
